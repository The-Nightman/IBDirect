        ...
        <form>
          <div>
            ...
            <fieldset className="my-2 py-3 border-b">
              <div className="flex flex-col lg:flex-row lg:gap-x-8">
                <legend className="max-w-lg mb-2">
                  How frequently are you having to take trips to the toilet to
                  empty your bowels? (average number of trips, include trips
                  even if only blood or liquid was passed)
                </legend>
            ...
            <fieldset className="my-2 py-3 border-b">
              <div className="flex flex-col lg:flex-row lg:gap-x-8">
                <legend className="max-w-lg mb-2">
                  How would you rate the average abdominal pain or discomfort
          ...
          <div>
            ...
            <fieldset className="my-2 py-3 border-b">
              <div className="flex flex-col lg:flex-row lg:gap-x-8">
                <legend className="max-w-lg mb-2">
                  B. Your current treatment is working well for you in
          ...
          <div>
            <fieldset className="my-2 py-3 border-b">
              <div className="flex flex-col lg:flex-row lg:gap-x-8">
                <legend className="max-w-lg mb-2">
                  <h4 className="font-semibold text-blue-700 underline">
                    2. Over the past 2 weeks, have your bowel symptoms gotten
                    worse, gotten better or not changed?
                  </h4>
                </legend>
                <div className="flex flex-col">
                  <label>
          ...
          <div>
            <fieldset className="my-2 py-3 border-b">
              <div className="flex flex-col lg:flex-row lg:gap-x-8">
                <legend className="max-w-lg mb-2">
                  <h4 className="font-semibold text-blue-700 underline">
                    4. How would you rate the OVERALL control of your IBD over
                    the past 2 weeks?
                  </h4>
                  <br />
                ...
                <div className="flex flex-col px-2">
                  ...
                  <label className="w-full flex flex-col text-center">
                    <input
                      ...
                      step={1}
                      value={
                        typeof survey.q12 === "number" ? `${survey.q12}` : "5"
                      }
                      readOnly
                    />
                    {survey.q12 === null
            ...
            <div className="flex flex-col lg:flex-row lg:gap-x-8">
              <div className="lg:w-[32rem]">
                <span className="sr-only">
                  ...
                  score of 0, 1 or 2. The Activity Index Score ranges from 0
                  (worst control and most activity) to 16 (best control and
                  least activity).
                </span>
                <Tooltip
